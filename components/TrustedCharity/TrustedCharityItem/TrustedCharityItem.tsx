...
const TrustedCharityItem = () => {
  return (
    ...
    <div className="w-10 h-10  bg-[#EAFEFF] z-0 rounded-full hover absolute duration-500 inset-1/2 group-hover:opacity-100 group-hover:scale-[26] transition-all group-hover:duration-[1.25s] group-hover:bg-[#006067]  group-hover:z-1"></div>
